...
class NewsViewModelTest {
    ...
    fun `when Get HeadlineNews Should Not Null and Return Success`() {
        ...
        val expectedTest = MutableLiveData<Result<List<NewsEntity>>>()
        expectedTest.value = Result.Success(dummyNews)
        `when`(newsRepository.getHeadlineNews()).thenReturn(expectedTest)
